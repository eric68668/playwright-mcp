...
> npx @playwright/mcp@latest --help
  ...
  --vision                     Run server that uses screenshots (Aria snapshots
                               are used by default)
  --record-video-dir <path>    path to the directory for record video.
  --auto-screen-shot           Whether to automatically take screenshots after
                               executing whitelisted tools. Defaults to true.
```
