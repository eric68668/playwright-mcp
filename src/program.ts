...
program
    ...
    .option('--record-video-dir <path>', 'path to the directory for record video.')
    .option('--auto-screen-shot', 'Whether to automatically take screenshots after executing whitelisted tools. Defaults to true.')
