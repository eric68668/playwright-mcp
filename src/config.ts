...
export async function configFromCLIOptions(cliOptions: CLIOptions): Promise<Config> {
  ...
  if (cliOptions.recordVideoDir) {
    try {
      contextOptions.recordVideo = { dir: cliOptions.recordVideoDir };
    } catch (e) {
      throw new Error('Invalid record video directory format: use "dir", for example --record-video-dir="path/to/video"');
    }
  }
